...
class MultiWiiPy3:
    ...
    """MultiWiiPy3 Serial Protocol message ID"""
    ...
    def __init__(self, serPort):
        ...
        self.ser.baudrate = 115200#230400#115200
    ...
    """
    Modification required on MultiWiiPy3 firmware to Protocol.cpp in evaluateCommand:
    case MSP_SET_RAW_RC:
    ...
    def arm(self):
        ...
        while timer < 0.5:
            ...
            self.sendCMD(8,MultiWiiPy3.SET_RAW_RC,data)
            time.sleep(0.05)
    ...
    def setPID(self,pd):
        ...
        self.sendCMD(30,MultiWiiPy3.SET_PID,data)
        self.sendCMD(0,MultiWiiPy3.EEPROM_WRITE,[])
